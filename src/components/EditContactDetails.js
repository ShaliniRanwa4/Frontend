  ...
  return (
    <div className="my-28 ">
      <div className="container mx-auto  w-3/5 ">
        ...
        <h1 className="mt-10 font-bold text-2xl flex justify-start my-4 ">
          Location
        </h1>
        ...
        <label className="text-lg  font-medium ">Street Adress</label>
        <input
          type="text"
          placeholder=""
          className="input input-bordered w-full mt-2 mb-5 "
        ...
        <div className="flex justify-center mt-3 ">
          <button className="btn btn-outline font-bold text-lg btn-success w-1/6 ">
            Save
          </button>
        </div>
      </div>
