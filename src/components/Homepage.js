...
const Homepage = () => {
  ...
  return (
    <>
      <h2 className="flex justify-end text-base text-orange-400 cursor-pointer mt-20"> Want personalized job matches ? Login /Sign Up ! </h2>
      ...
      <div className="  flex justify-center items-center mx-auto mt-10  w-11/12 ">
